...
<div class="bg-gray-50">
    <div class="container mx-auto px-6 py-20">
        <div class="max-w-3xl mx-auto bg-white p-8 md:p-12 rounded-xl shadow-2xl text-center" data-aos="zoom-in">
            ...
            {{-- =============================================== --}}
            <div class="mt-8">
                <a href="{{ route('ppdb.download', ['pendaftaran' => $pendaftaran->id]) }}" 
                   target="_blank"
                   class="inline-flex items-center bg-blue-600 text-white font-bold px-6 py-3 rounded-lg shadow-lg hover:bg-blue-700 transition-all">
